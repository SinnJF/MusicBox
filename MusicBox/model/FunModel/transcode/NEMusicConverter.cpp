...
NEMusicConverter::NEMusicConverter(QObject *parent)
    : MusicConverter{parent}
{

}

void NEMusicConverter::Decrypt(const std::filesystem::path &originalFilePath, bool write163Key, std::filesystem::path _outputPath)
{
...
void NEMusicConverter::SetMusicInfo(std::filesystem::path &originalFilePath, musicInfo &info, bool write163Key)
{
